...
const App: React.FC = () => {
  ...
  const envApiKey = (typeof process !== 'undefined' && process.env && process.env.GROQ_API_KEY) || import.meta.env.VITE_GROQ_API_KEY || import.meta.env.GROQ_API_KEY;
  const envOutlookId = (typeof process !== 'undefined' && process.env && process.env.OUTLOOK_CLIENT_ID) || import.meta.env.VITE_OUTLOOK_CLIENT_ID || import.meta.env.OUTLOOK_CLIENT_ID;
